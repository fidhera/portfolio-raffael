...
const projectData = [
  {
    ...
    desc: "Digitalisasi rekam medis pasien dengan sistem keamanan terenkripsi.",
  ...
  {
    id: 2,
    title: "SXC Event Landing",
    desc: "Website pendaftaran event internasional dengan payment gateway.",
